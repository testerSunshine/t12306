...
class Request(object):
    ...
    def getHeaders(self):
        return {
            ...
            "X-Forwarded-For": str(random.randint(58, 61)) + '.' + str(random.randint(10, 200)) + '.' + str(
                random.randint(10, 200)) + '.' + str(random.randint(10, 200))
        }
    ...
    def request(self, reqType, data=(), gp='GET', dataIsConfig=False, getR=False,):
        ...
        timeout = 20
        oldHost = ''
        oldReferer = 'https://kyfw.12306.cn/otn/login/init'
